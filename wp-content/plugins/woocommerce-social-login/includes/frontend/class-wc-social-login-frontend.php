...
class WC_Social_Login_Frontend {
	...
	public function render_social_login_profile() {
		...
		wc_get_template(
			...
			array(
				'linked_profiles'     => $GLOBALS['wc_social_login']->get_user_social_login_profiles(),
	...
	public function load_styles_scripts() {
		...
		wp_add_inline_style( 'wc-social-login-frontend', $GLOBALS['wc_social_login']->get_button_colors_css() );
	}
